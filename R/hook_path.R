...
#'
#' @return A length-1 character vector giving the conventional hooks
#'   directory path.
#' @export
#'
#' @examples
...
hook_path <- function(agent = NULL, scope = c('project', 'global')) {
  scope <- rlang::arg_match(scope)
  get_scope_path(agent, scope, hook_paths)
}
