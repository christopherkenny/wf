...
#'
#' @return A length-1 character vector giving the conventional rules path.
#' @export
#'
#' @examples
...
rule_path <- function(agent = NULL, scope = c('project', 'global')) {
  scope <- rlang::arg_match(scope)
  get_scope_path(agent, scope, rule_paths)
}
